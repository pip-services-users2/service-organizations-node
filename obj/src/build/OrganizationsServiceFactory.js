...
const OrganizationsHttpServiceV1_1 = require("../services/version1/OrganizationsHttpServiceV1");
...
class OrganizationsServiceFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(OrganizationsServiceFactory.HttpServiceDescriptor, OrganizationsHttpServiceV1_1.OrganizationsHttpServiceV1);
...
OrganizationsServiceFactory.HttpServiceDescriptor = new pip_services3_commons_nodex_1.Descriptor("service-organizations", "service", "http", "*", "1.0");
